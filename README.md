...
Messenger Privacy Protector is an unpacked Chrome extension that helps you quickly bulk unsend your messages within a selected chat. Once enabled, it streamlines and automates message removal for the current conversation.
